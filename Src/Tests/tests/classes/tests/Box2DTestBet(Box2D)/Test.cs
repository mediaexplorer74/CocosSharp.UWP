...
namespace Box2D.TestBed
{
    ...
    public class Test : b2ContactListener
    {
        ...
        public Test()
        {
            ...
            m_world.SetDebugDraw(debugDraw: m_debugDraw);
    ...
    public class CCBox2dDraw : b2Draw
    {
        ...
        public CCBox2dDraw(string v1, int v2)
        {
            this.v1 = v1;
            this.v2 = v2;
        }
        ...
        internal void DrawAABB(b2AABB m_queryAABB, b2Color cc)
        {
            throw new NotImplementedException();
        }

        internal void DrawPoint(b2Vec2 p1, float v, b2Color c)
        {
            throw new NotImplementedException();
        }

        internal void DrawString(int v1, int m_textLine, string v2, int bodyCount, int contactCount, int jointCount)
        {
            throw new NotImplementedException();
        }

        internal void DrawString(int x, int y, string title)
        {
            throw new NotImplementedException();
        }

        internal void DrawString(int v1, int m_textLine, string v2, int proxyCount, int height, int balance, float quality)
        {
            throw new NotImplementedException();
        }

        internal void DrawString(int v1, int m_textLine, string v2, float v3, int b2_toiMaxRootIters)
        {
            throw new NotImplementedException();
        }

        internal void DrawString(int v1, int m_textLine, string v2, float t)
        {
            throw new NotImplementedException();
        }

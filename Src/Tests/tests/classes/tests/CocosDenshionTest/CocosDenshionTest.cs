...
//            AddChildAt(sliderGain, 0.72f, 0.19f);
    ...
    internal class CCControlSlider
    {
        public float Scale { get; internal set; }
        public float Rotation { get; internal set; }
        public float Value { get; internal set; }
        public float MinimumValue { get; internal set; }
        public float MaximumValue { get; internal set; }

        private string v1;
        private string v2;
        private string v3;

        public CCControlSlider(string v1, string v2, string v3)
        {
            this.v1 = v1;
            this.v2 = v2;
            this.v3 = v3;
